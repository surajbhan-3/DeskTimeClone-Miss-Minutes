...
async function fetchdata() {
    try {
        let res = await fetch(`https://chat-backend-poised-slaved.onrender.com/project/details/${projectid}`, {
            method: "GET",
            headers: {
...
async function fetchdata1() {
    try {
        let res = await fetch(`https://chat-backend-poised-slaved.onrender.com/task/project/${projectid}`, {
            method: "GET",
            headers: {
                "Content-Type": "application/json",
                "Authorization": `${token}`
...
async function fetchdata2() {
    try {
        let res = await fetch(`https://chat-backend-poised-slaved.onrender.com/task/${projectid}/users`, {
            method: "GET",
            headers: {
                "Content-Type": "application/json",
                "Authorization": `${token}`
